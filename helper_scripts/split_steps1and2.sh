...
NUM_SECTIONS=3 # number of sections to split the input file into
SCRIPT_LOC="/home/peter/TE-discovery/mainscript.pl" # location of mainscript.pl
GENOME_LOC="/home/peter/Desktop/GCF_000365465.3_Ptep_3.0_genomic.fna" # location of genome, formated with 'makeblastdb'
ANALYSIS_FOLDER="./Analysis_files" # path where to store the combined results
ELEMENT_FOLDER="./Element_files" # path where to store the combined results
...
# STEP 3:	Combine the results into element and analysis folders
