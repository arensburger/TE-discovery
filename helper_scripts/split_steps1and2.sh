...
TEMP_FOLDER="$PWD/temp" # path to the new temporary directory
TBLASTN_LOC="$PWD/tblastn.o" # path to the tblastn.o output file
...
ANALYSIS_FOLDER="$PWD/Ptep3_Analysis_files" # path where to store the combined results
ELEMENT_FOLDER="$PWD/Ptep3_Element_files" # path where to store the combined results
...
wait # make sure the processes above are done before going to the next step
